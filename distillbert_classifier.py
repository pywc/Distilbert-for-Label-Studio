...
class DistilBertClassifier(LabelStudioMLBase):
    ...
    def __init__(
        self, pretrained_model='distilbert-base-multilingual-cased', maxlen=256,
        batch_size=32, num_epochs=30, logging_steps=1, train_logs=None, **kwargs
    ):
        ...
        if not self.train_output:
            ...
            self.model = self.reset_model('distilbert-base-multilingual-cased', cache_dir=None, device='cpu')
    ...
    def load(self, train_output):
        ...
        self.model = DistilBertForSequenceClassification.from_pretrained(pretrained_model)
    ...
    def fit(self, completions, workdir=None, cache_dir=None, **kwargs):
        ...
        tokenizer = DistilBertTokenizer.from_pretrained(self.pretrained_model, cache_dir=cache_dir)
